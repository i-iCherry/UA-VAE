...
class BasicModel(ABC):
    ...
    def save_networks(self, epoch):
        ...
        """
        # self.model_names.append("ConfidNet")
        ...
        path = "checkpoints/test/confidnet.pth"
        torch.save(self.confidnet.state_dict(), path)
