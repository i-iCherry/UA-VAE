...
class TrainTestParams(BasicParams):
    ...
    def initialize(self, parser):
        ...
        # Training parameters
        parser.add_argument('--epoch_num_p1', type=int, default=1,  # 50
                            help='epoch number for phase 1')
        parser.add_argument('--epoch_num_p2', type=int, default=1,  # 50
                            help='epoch number for phase 2')
        parser.add_argument('--epoch_num_p3', type=int, default=1,  # 100
                            help='epoch number for phase 3')
        parser.add_argument('--epoch_num_p4', type=int, default=1,  # 50 (cinfidnet)
                            help='epoch number for phase 4')
        parser.add_argument('--epoch_num_p5', type=int, default=1,  # 50 （VAE）
                            help='epoch number for phase 5')
        ...
        # Dataset parameters
        parser.add_argument('--train_ratio', type=float, default=0.8,  # 0.8（原始论文，加入校正后改为0.6）
