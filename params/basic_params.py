...
class BasicParams:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--net_VAE', type=str, default='fc_sep',
                            help='specify the backbone of the VAE, default is the one dimensional CNN, options: [ fc_sep ]')
        parser.add_argument('--net_down', type=str, default='multi_FC_classifier',
                            help='specify the backbone of the downstream task network, default is the multi-layer FC classifier, options: [multi_FC_classifier ]')
    ...
    def parse(self):
        ...
        if self.isTrain:
            param.epoch_num = param.epoch_num_p1 + param.epoch_num_p2 + param.epoch_num_p3 + param.epoch_num_p4 + param.epoch_num_p5
